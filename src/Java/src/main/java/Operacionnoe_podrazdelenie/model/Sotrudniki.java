 ...
 */
@Entity(name = "IISOperacionnoe_podrazdelenieСотрудники")
...
public class Sotrudniki {
    ...
    @Column(name = "IDСотрудн")
    private Integer idсотрудн;
    ...
    public Integer getIDСотрудн() {
      return idсотрудн;
    }

    public void setIDСотрудн(Integer idсотрудн) {
      this.idсотрудн = idсотрудн;
    }
