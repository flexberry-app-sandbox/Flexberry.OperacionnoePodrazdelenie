...
moduleForModel('i-i-s-operacionnoe-podrazdelenie-закрытие-счета', 'Unit | Serializer | i-i-s-operacionnoe-podrazdelenie-закрытие-счета', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-operacionnoe-podrazdelenie-закрытие-счета',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
