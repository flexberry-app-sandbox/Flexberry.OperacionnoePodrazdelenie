...
moduleForModel('i-i-s-operacionnoe-podrazdelenie-формир-досье', 'Unit | Serializer | i-i-s-operacionnoe-podrazdelenie-формир-досье', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-operacionnoe-podrazdelenie-формир-досье',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
