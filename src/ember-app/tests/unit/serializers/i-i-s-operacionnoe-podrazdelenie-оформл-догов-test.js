...
moduleForModel('i-i-s-operacionnoe-podrazdelenie-оформл-догов', 'Unit | Serializer | i-i-s-operacionnoe-podrazdelenie-оформл-догов', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-operacionnoe-podrazdelenie-оформл-догов',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
