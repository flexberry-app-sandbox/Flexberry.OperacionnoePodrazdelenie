...
moduleForModel('i-i-s-operacionnoe-podrazdelenie-клиенты', 'Unit | Serializer | i-i-s-operacionnoe-podrazdelenie-клиенты', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-operacionnoe-podrazdelenie-клиенты',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
