...
moduleForModel('i-i-s-operacionnoe-podrazdelenie-организация', 'Unit | Serializer | i-i-s-operacionnoe-podrazdelenie-организация', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-operacionnoe-podrazdelenie-организация',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
