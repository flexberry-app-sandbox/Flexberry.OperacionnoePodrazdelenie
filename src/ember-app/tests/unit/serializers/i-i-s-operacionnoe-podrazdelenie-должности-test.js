...
moduleForModel('i-i-s-operacionnoe-podrazdelenie-должности', 'Unit | Serializer | i-i-s-operacionnoe-podrazdelenie-должности', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-operacionnoe-podrazdelenie-должности',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
