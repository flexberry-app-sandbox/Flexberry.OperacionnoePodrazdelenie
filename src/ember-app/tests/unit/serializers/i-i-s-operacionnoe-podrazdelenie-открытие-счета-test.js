...
moduleForModel('i-i-s-operacionnoe-podrazdelenie-открытие-счета', 'Unit | Serializer | i-i-s-operacionnoe-podrazdelenie-открытие-счета', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-operacionnoe-podrazdelenie-открытие-счета',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
