...
moduleForModel('i-i-s-operacionnoe-podrazdelenie-прием-и-обр-поруч', 'Unit | Serializer | i-i-s-operacionnoe-podrazdelenie-прием-и-обр-поруч', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-operacionnoe-podrazdelenie-прием-и-обр-поруч',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
