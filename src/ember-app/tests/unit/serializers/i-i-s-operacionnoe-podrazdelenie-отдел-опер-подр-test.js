...
moduleForModel('i-i-s-operacionnoe-podrazdelenie-отдел-опер-подр', 'Unit | Serializer | i-i-s-operacionnoe-podrazdelenie-отдел-опер-подр', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-operacionnoe-podrazdelenie-отдел-опер-подр',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
