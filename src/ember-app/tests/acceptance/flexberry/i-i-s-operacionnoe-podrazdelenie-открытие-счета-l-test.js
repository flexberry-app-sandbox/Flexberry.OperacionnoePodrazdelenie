...
moduleForAcceptance('[AGAT] Acceptance | i i s operacionnoe podrazdelenie открытие счета l');

test('testing i-i-s-operacionnoe-podrazdelenie-открытие-счета-l', function(assert) {
