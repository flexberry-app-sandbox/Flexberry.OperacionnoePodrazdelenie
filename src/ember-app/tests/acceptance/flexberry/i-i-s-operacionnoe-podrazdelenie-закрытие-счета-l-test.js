...
moduleForAcceptance('[AGAT] Acceptance | i i s operacionnoe podrazdelenie закрытие счета l');

test('testing i-i-s-operacionnoe-podrazdelenie-закрытие-счета-l', function(assert) {
