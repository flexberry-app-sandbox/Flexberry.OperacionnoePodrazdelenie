...
moduleForAcceptance('[AGAT] Acceptance | i i s operacionnoe podrazdelenie отдел опер подр l');

test('testing i-i-s-operacionnoe-podrazdelenie-отдел-опер-подр-l', function(assert) {
