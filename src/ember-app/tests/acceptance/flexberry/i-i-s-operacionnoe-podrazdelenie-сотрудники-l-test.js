...
moduleForAcceptance('[AGAT] Acceptance | i i s operacionnoe podrazdelenie сотрудники l');

test('testing i-i-s-operacionnoe-podrazdelenie-сотрудники-l', function(assert) {
