...
moduleForAcceptance('[AGAT] Acceptance | i i s operacionnoe podrazdelenie прием и обр поруч l');

test('testing i-i-s-operacionnoe-podrazdelenie-прием-и-обр-поруч-l', function(assert) {
