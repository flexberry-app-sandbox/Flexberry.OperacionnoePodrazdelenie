...
moduleForAcceptance('[AGAT] Acceptance | i i s operacionnoe podrazdelenie формир досье l');

test('testing i-i-s-operacionnoe-podrazdelenie-формир-досье-l', function(assert) {
