...
moduleForAcceptance('[AGAT] Acceptance | i i s operacionnoe podrazdelenie должности l');

test('testing i-i-s-operacionnoe-podrazdelenie-должности-l', function(assert) {
